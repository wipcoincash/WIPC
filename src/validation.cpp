...
#if defined(NDEBUG)
# error "wipcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "WipCoin Signed Message:\n";
...
CAmount GetBlockSubsidy(int nPrevBits, int nPrevHeight, const Consensus::Params& consensusParams, bool fSuperblockPartOnly)
{
   if (nPrevHeight <= 14) 
        return 500000 * COIN;
    if (nPrevHeight > 14 && nPrevHeight <= 15000)
        return 0 * COIN;
    if (nPrevHeight >= 15001 && nPrevHeight <= 30000)
        return 0.5 * COIN;
    if (nPrevHeight >= 30001 && nPrevHeight <= 45000)
        return 10 * COIN;
    if (nPrevHeight >= 45001 && nPrevHeight <= 75000)
        return 15 * COIN;
    if (nPrevHeight >= 75001 && nPrevHeight <= 105000)
        return 20 * COIN;
    if (nPrevHeight >= 105001 && nPrevHeight <= 165000)
        return 25 * COIN;
    if (nPrevHeight >= 165001 && nPrevHeight <= 215000)
        return 30 * COIN;
    if (nPrevHeight >= 215001 && nPrevHeight <= 265000)
        return 35 * COIN;
    if (nPrevHeight >= 265001 && nPrevHeight <= 365000)
        return 15 * COIN;
    if (nPrevHeight >= 365001 && nPrevHeight <= 515000)
        return 13 * COIN;
    if (nPrevHeight >= 515001)
        return 10 * COIN;
...
{
    if (nHeight <= 30000)                       return (blockValue * 0);
    if (nHeight > 30000  && nHeight <= 105000)  return (blockValue * 0.80);
    if (nHeight > 105000 && nHeight <= 165000)  return (blockValue * 0.82);
    if (nHeight > 165000 && nHeight <= 215000)  return (blockValue * 0.84);
    if (nHeight > 215000 && nHeight <= 265000)  return (blockValue * 0.86);
    if (nHeight > 265000 && nHeight <= 365000)  return (blockValue * 0.88);
    if (nHeight > 365000 && nHeight <= 515000)  return (blockValue * 0.88);
    if (nHeight > 515000)                       return (blockValue * 0.70); 
}
