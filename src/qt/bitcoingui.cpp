...
#include "config/wipcoin-config.h"
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a wipcoin address"));
    ...
    aboutAction->setStatusTip(tr("Show information about wipcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your wipcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified wipcoin addresses"));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to wipcoin network", "", count));
    } else {
...
{
    QString strTitle = tr("wipcoin"); // default title
