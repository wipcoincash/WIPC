...
const char * const BITCOIN_CONF_FILENAME = "wipcoin.conf";
const char * const BITCOIN_PID_FILENAME = "wipcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "wipcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/wipcoin";
#else
    // Unix
    return pathRet / ".wipcoin";
#endif
#endif
}
