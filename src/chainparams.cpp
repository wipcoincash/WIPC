...
{
    const char* pszTimestamp = "Wipcoin MainNet 2019";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1569744249, 191269, 0x1e0fffff, 1, 0 * COIN);
	    consensus.hashGenesisBlock = genesis.GetHash();
      
        assert(consensus.hashGenesisBlock == uint256S("0x7e968b5b3f68952189092c0b55c9feca29fe1a0f42086688dc28fc92b4ef9156"));
        assert(genesis.hashMerkleRoot == uint256S("0x811edab54f24d6522ce10084870b45a1886f382d02b1b45953479388e5b94d46"));

 
      
        // Wipcoin addresses start with 'w'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,135);
        // Wipcoin script addresses start with 'W'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,73);
        // Wipcoin private keys start with '2'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,228);
        // Wipcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x03)(0x68)(0xA3)(0x3D).convert_to_container<std::vector<unsigned char> >();
        // Wipcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x03)(0x68)(0xA3)(0xD5).convert_to_container<std::vector<unsigned char> >();

        // Wipcoin BIP44 coin type is '5'
        nExtCoinType = 5;
        ...
        vSporkAddresses = {"wiMeUKrbpuVZ3dHrhBdYGWphEeriwGgWf5"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1569744249, // * UNIX timestamp of last known number of transactions (Block 1068571)
