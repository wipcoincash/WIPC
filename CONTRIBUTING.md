Contributing to wipcoin
===============================

The wipcoin project operates an open contributor model where anyone is
...
The following applies to code changes to the wipcoin project (and related
projects such as libsecp256k1), and is not to be confused with overall Dash
Network Protocol consensus changes.

Whether a pull request is merged into wipcoin rests with the project merge
...
The project leader is the release manager for each wipcoin release.
