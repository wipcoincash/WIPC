...
*Setup instructions for a Gitian build of wipcoin using a Debian VM or physical system.*
...
- [Building wipcoin](#building-dash-core)
...
Clone the git repositories for wipcoin and Gitian.
...
in the wipcoin repository under 'Fetch and create inputs' to install sources which require
...
To build wipcoin (for Linux, OS X and Windows) just follow the steps under 'perform
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the wipcoin repository.
