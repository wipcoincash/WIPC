...
It is possible to run wipcoin as a Tor hidden service, and connect to such services.
...
1. Run wipcoin behind a Tor proxy
----------------------------------

The first step is running wipcoin behind a Tor proxy. This will already make all
...
your dashd's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell wipcoin about its publicly reachable address using
...
3. List of known wipcoin Tor relays
------------------------------------
...
wipcoin has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
wipcoin automatically creates a hidden service to listen on. This will positively 
affect the number of available .onion nodes.

This new feature is enabled by default if wipcoin is listening (`-listen`), and
