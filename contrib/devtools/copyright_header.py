...
Arguments:
    <base_directory> - The base directory of a wipcoin source code repository.
...
Arguments:
    <base_directory> - The base directory of wipcoin source code repository.
"""
...
Arguments:
    <file> - A source file in the wipcoin repository.
"""
